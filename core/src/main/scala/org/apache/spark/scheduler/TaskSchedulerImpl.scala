...
private[spark] class TaskSchedulerImpl(
  ...
  def nextOffer(offer: WorkerOffer, stage: TaskSetManager): Seq[TaskDescription] = synchronized {
    if (stage == null) {
